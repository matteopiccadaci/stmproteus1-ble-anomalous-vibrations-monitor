...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PD6     ------> QUADSPI_BK1_IO2
    */
    HAL_GPIO_DeInit(GPIOB, QUADSPI_BK1_IO0_Pin|QUADSPI_BK1_NCS_Pin);

    HAL_GPIO_DeInit(QUADSPI_CLK_GPIO_Port, QUADSPI_CLK_Pin);

    HAL_GPIO_DeInit(GPIOD, QUADSPI_BK1_IO3_Pin|QUADSPI_BK1_IO1_Pin|QUADSPI_BK1_IO2_Pin);
