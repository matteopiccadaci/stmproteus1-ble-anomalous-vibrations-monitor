...
/* Payload:
   ...
   EQ_ANOM  = [0]=anom(0/1) [1]=similarity(0..100) */
...
/* USER CODE BEGIN PFP */
//Functions taken from FP-AI-PDMWBSOC2 firmware
...
/**
 * @brief Aggiorna e notifica la characteristic anomalia.
 ...
 *        Si invia sempre update + notify esplicita al client connesso così l’app riceve subito il valore.
 */
